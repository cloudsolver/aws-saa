[EC2 connect](https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-connect-methods.html) is a browser based CLI compatible with Amazon Linux 2 and Ubuntu 16.04 or later.
